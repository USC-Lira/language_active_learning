...
def bald_learning(
    ...
    while i < num_queries:
        ...
        # print(f"Average Loss: {total_loss.item() / (args.num_models * args.num_iterations):.4f}, Average Norm of learned reward: {average_norm.item():.4f}")
...
def run(args):
    ...
    # plt.tight_layout()
    # plt.savefig(f"{args.true_reward_dir}/pref_learning/bald_{args.seed}.png")
